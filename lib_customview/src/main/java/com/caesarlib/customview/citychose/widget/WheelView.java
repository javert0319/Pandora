...
package com.caesarlib.customview.citychose.widget;
...
import com.caesarlib.customview.citychose.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.res_tools_line_border));
        // 设置线宽
